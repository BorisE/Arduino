 ...
 */
 ...
 /*
 * Брал пример отсюда https://github.com/zhouhan0126/WebServer-esp32/tree/master/examples/FSBrowser
 * При этом SPIFFS работает только на этой версии 0.5 https://github.com/esp8266/arduino-esp8266fs-plugin/releases/download/0.5.0/ESP8266FS-0.5.0.zip
 * Проверять здесь https://github.com/esp8266/arduino-esp8266fs-plugin/releases
 */
...
const char* ssid = "BATMAJ";
const char* password = "8oknehcmE";
