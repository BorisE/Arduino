...
//STEPPER------------------------------------------------
int stepsPerCycle = 1200;   // change this to fit the number of steps per revolution
int motorSpeed=20;             // rotation speed in RPM

int stepperInitPosition = 0;   // start position
...
void setup() {
  //////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
  Serial.begin(9600);
  Serial.println("Objective Dome v0.2");
  Serial.println("[!ver:0.2]");
